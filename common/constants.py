...
class Components:
    ...
    ENABLED_COMPONENTS = {
        'bodycam': MetadataConstants.ENABLE_BODY_CAM,
...
class Paths:
    ...
    BODY_LEFT_RAW_PATH = "body" if MetadataConstants.ENABLE_BODY_CAM else None
    #BODY_RIGHT_RAW_PATH = "body_right/raw" if MetadataConstants.ENABLE_BODY_CAM else None
    BODY_RIGHT_RAW_PATH = None
    DARTBOARD_RAW_PATH = "dart" if MetadataConstants.ENABLE_DART_CAM else None
    ...
    BODY_LEFT_PROCESSED_PATH = None
    BODY_RIGHT_PROCESSED_PATH = None
