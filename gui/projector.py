...
class ImageDisplayApp(QWidget):
    def __init__(self):
        ...
        # Load images
        self.image_paths = ["C:/Users/Data acquisition/sensorimotorkit/assets/targets/1.png", "C:/Users/Data acquisition/sensorimotorkit/assets/targets/2.png"]  # Add your image paths here
